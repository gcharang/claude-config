...
Step 1 is anchored on `$CLAUDE_PROJECT_DIR`, then the caller's working directory: run it
from inside the project and do not `cd` into the skills tree. The two entry-point commands live in
